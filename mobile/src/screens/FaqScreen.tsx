...
const FAQS: { q: string; a: string }[] = [
  { q: 'كيف يمكنني التبرع عبر التطبيق؟', a: 'اختر وجهة التبرع (حالة، مشروع، أو صندوق)، حدّد المبلغ، ثم اختر إحدى وسائل التبرع: تحويل بنكي/إنستاباي على حساب الجمعية في CIB، أو كود فوري 74000، أو فودافون كاش. بعد إتمام التحويل أرسل صورة الإيصال عبر واتساب ليعتمد فريق الجمعية تبرعك.' },
