...
| 25 | Bookings | Engine + Serializable-tx concurrency | PASS | PASS | PASS | — | PASS | PASS | **PASS** ✅ | race PROVEN on a real DB (2-way + 5-way); P2034 → 409 fixed; **partial unique index now applied on production** — T-09's last open piece, unblocked by the read-only server check finding zero duplicates |
