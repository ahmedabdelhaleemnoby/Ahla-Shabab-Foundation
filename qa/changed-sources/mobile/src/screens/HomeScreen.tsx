    ...
    <Screen header={<AppBar />}>
      ...
      >
        <View style={[row, { gap: 10, justifyContent: 'flex-end' }]}>
          ...
          <View style={{ width: 46, height: 46, borderRadius: 23, backgroundColor: 'rgba(255,255,255,.14)', alignItems: 'center', justifyContent: 'center' }}>
            <Text style={[font('800'), { color: '#fff', fontSize: 20 }]}>خ</Text>
          </View>
        </View>
