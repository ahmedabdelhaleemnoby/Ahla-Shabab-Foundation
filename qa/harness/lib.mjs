...
// Override any of these with env vars: CHROME_PATH, BASE_URL, SHOTS_DIR.
const HERE = dirname(fileURLToPath(import.meta.url));

export const CHROME =
  process.env.CHROME_PATH ?? '/Applications/Google Chrome.app/Contents/MacOS/Google Chrome';
export const BASE = process.env.BASE_URL ?? 'http://localhost:8087';
export const SHOTS = process.env.SHOTS_DIR ?? resolve(HERE, '../screenshots/mobile');
